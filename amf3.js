...
(function() {
  ...
  Decoder = (function(_super) {
    ...
    Decoder.prototype._getClassDefinition = function(ref) {
      ...
      ref = ref >> 1;
      if (isRef) return this.getClassFromReference(ref);
      name = this.readString();
      if (name === 'DSK') {
      ...
      } else if (name === 'flex.messaging.messages.RemotingMessage') {} else {
        process.exit();
      }
      this.addClass(name, thing);
      return thing;
  ...
  Encoder = (function(_super) {
    ...
    function Encoder(buffer, offset) {
      this.buffer = buffer;
      this.offset = offset != null ? offset : 0;
      if (!this.buffer) this.buffer = new Buffer(10485760);
    }
    ...
    Encoder.prototype.writeNumber = function(num, writeType) {
      if (writeType == null) writeType = true;
      if (writeType) this.writeType(TYPE_NUMBER);
    ...
    Encoder.prototype.writeInteger = function(num, writeType) {
      ...
      if (num < MIN_29B_INT || num > MAX_29B_INT) {
        ...
        if (writeType) this.writeType(TYPE_INTEGER);
    ...
    Encoder.prototype.writeString = function(str, writeType) {
      var flag, len, ref;
      if (writeType == null) writeType = true;
      if (writeType) this.writeType(TYPE_STRING);
    ...
    Encoder.prototype._encodeInteger = function(num) {
      ...
      if (num > 0x3fff) bytes.push(0x80 | ((num >> 14) & 0xff));
      if (num > 0x7f) bytes.push(0x80 | ((num >> 7) & 0xff));
      if (realValue === !null) num = realValue;
      if (num > 0x1fffff) {
        bytes.push(num & 0xff);
      } else {
        bytes.push(num & 0x7f);
