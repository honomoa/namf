...
(function() {
  ...
  AbstractMessage = (function() {
    ...
    AbstractMessage.prototype.encodeSmallAttribute = function(attr, encoder) {
      ...
      obj = this[attr];
      if (!obj) return obj;
      if (attr === 'timestamp' || attr === 'timeToLive') return obj;
      if (attr === 'messageId' || attr === 'clientId') return null;
      return obj;
    };
    ...
    AbstractMessage.prototype._readamf = function(decoder) {
      ...
      if (flags.length > 2) throw 'Too many flags';
      idx = 0;
      _results = [];
  ...
  AsyncMessage = (function(_super) {
    ...
    AsyncMessage.prototype._readamf = function(decoder) {
      ...
      flags = readFlags(decoder);
      if (flags.length > 1) throw 'Too many flags';
      byte = flags[0];
      if (byte & 0x01) this.correlationId = decoder.readValue();
      if (byte & 0x02) return this.correlationId = decoder.readValue();
    };
