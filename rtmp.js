...
(function() {
  var AMF0Decoder, AMF0Encoder, RTMPClient, RTMPCommand, RTMPHeader, RTMPMessage, RTMPProtocol, assert, dataQ, hexy, MoaLog,
  ...
  RTMPClient = (function(_super) {
    ...
    RTMPClient.prototype.send = function(cmd, cb) {
      ...
      closeSocket = function() {
        ...
        MoaLog.info('Timeout reached, closing socket.');
    ...
    /*
        MoaLog.debug('gggggggggggg', message.streamId, @nextChannelId);
        dataQ = Buffer.concat([dataQ, data]);
        if (dataQ.length > 1000 && this.nextChannelId > 6 && this.socket.writable) {
          this.socket.write(dataQ);
          dataQ = new Buffer(0);
        }
        else if (this.nextChannelId <= 6 && this.socket.writable) {
          this.socket.write(dataQ);
          dataQ = new Buffer(0);
        }
    */
  ...
  RTMPCommand = (function() {
    ...
    RTMPCommand.fromMessage = function(message) {
      ...
      if (cmd.name === '_error') {
        MoaLog.error(cmd.args[0].object.rootCause);
        if (((_ref = cmd.args[0]) != null ? (_ref1 = _ref.object) != null ? (_ref2 = _ref1.rootCause) != null ? (_ref3 = _ref2.object) != null ? _ref3.errorCode : void 0 : void 0 : void 0 : void 0) === 'LOGIN-0001') {
          MoaLog.file('ver', cmd.args[0].object.rootCause.object.substitutionArguments[1]);
        } else {
          MoaLog.file('ERROR_' + cmd.args[0].object.rootCause.object.errorCode + '.txt', cmd);
        }
        MoaLog.info(cmd);
        MoaLog.debug(hexy.hexy(data));
      }
