...
(function() {
  var AMF0Decoder, AMF0Encoder, RTMPClient, RTMPCommand, RTMPHeader, RTMPMessage, RTMPProtocol, assert, dataQ, fs, hexy, logFile,
  ...
  RTMPProtocol = (function() {
    ...
    RTMPProtocol.READ_WIN_SIZE = 1250000;
  ...
  RTMPClient = (function(_super) {
    ...
    RTMPClient.prototype.parseData = function(data) {
      ...
      if (this.partialMessage) {
        ...
        if (this.partialMessage.data.length >= totalSize) {
          ...
          if (extraData) return this.parseData(extraData);
        }
      } else {
        CHANNEL_MASK = 0x3F;
        offset = 0;
      ...
      while (offset < data.length) {
        ...
        if (packetData.length < header.size) {
          ...
          if (packetData.length === header.size) {
            ...
            if (this.incompletePackets['3']) delete this.incompletePackets['3'];
          } else {
          ...
          return msg;
          if (msg.type === RTMPMessage.ACK) console.log(hexy.hexy(data));
        }
      }
    };
    ...
    RTMPClient.prototype.writeMessage = function(message) {
      ...
      if (message.type < RTMPMessage.AUDIO) console.log(hexy.hexy(data));
      if (this.socket.writable) return this.socket.write(data);
    };
    ...
    */
    ...
    RTMPClient.prototype.messageReceived = function(msg) {
      ...
      if ((msg.type === RTMPMessage.RPC || msg.type === RTMPMessage.RPC3) && msg.streamId === 0) {
        ...
        if (this.debug) return console.log('UNKNOWN MSG?', msg);
      }
    };
  ...
  RTMPCommand = (function() {
    ...
    RTMPCommand.fromMessage = function(message) {
      var cmd, data, decoder, _ref, _ref1, _ref2, _ref3;
      ...
      if (message.data.length === 0) throw "Zero length message data.";
      data = null;
      ...
      if (cmd.name === '_error') {
        ...
        if (((_ref = cmd.args[0]) != null ? (_ref1 = _ref.object) != null ? (_ref2 = _ref1.rootCause) != null ? (_ref3 = _ref2.object) != null ? _ref3.errorCode : void 0 : void 0 : void 0 : void 0) === 'LOGIN-0001') {
  ...
  RTMPMessage = (function() {
    ...
    function RTMPMessage(header, data) {
      this.header = header;
      this.data = data;
      if (!this.header) this.header = new RTMPHeader();
      if (this.header.type) this.type = this.header.type;
      if (this.header.size) this.size = this.header.size;
      if (this.header.streamId) this.streamId = this.header.streamId;
      if (!this.streamId) this.streamId = 0;
      if (this.header.time) this.time = this.header.time;
    }
